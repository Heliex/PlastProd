...
\t<a class = \"liens\" href = \"";
        ...
        echo "\"><button class = \"cust_butt\"><p>Visualiser les infos de l'entreprise.</p></button></a>
\t<a class = \"liens\" href = \"";
        // line 12
        echo $this->env->getExtension('routing')->getPath("roger_plast_prod_client_communique");
        echo "\"><button class = \"cust_butt\"><p>Communiquer avec l'entreprise.</p></button></a>
\t<a class = \"liens\" href = \"";
        // line 13
        echo $this->env->getExtension('routing')->getPath("roger_plast_prod_client_suivi");
        echo "\"><button class = \"cust_butt\"><p>Suivre votre commande.</p></button></a>
</div>
";
    }
