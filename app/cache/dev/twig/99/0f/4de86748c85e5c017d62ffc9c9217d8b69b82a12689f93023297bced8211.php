...
\t\t<a class = \"liens\" href = \"";
        // line 56
        echo $this->env->getExtension('routing')->getPath("roger_plast_prod_stocks");
        echo " \"><div class = \"btn-stocks\">
\t\t</div></a>
\t\t<a class = \"liens\" href =\"";
        // line 58
        echo $this->env->getExtension('routing')->getPath("roger_plast_prod_config");
        echo "\" ><div class=\"btn-config\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/PlastProd/images/config.jpg"), "html", null, true);
        echo "\"/></div></a>
\t</div>
\t";
        // line 60
...
\t\t";
    ...
    {
        return array (  163 => 61,  160 => 60,  154 => 19,  149 => 18,  146 => 17,  140 => 14,  136 => 13,  131 => 12,  128 => 11,  123 => 8,  120 => 7,  111 => 62,  109 => 60,  102 => 58,  97 => 56,  92 => 54,  87 => 52,  82 => 50,  76 => 47,  51 => 25,  47 => 24,  42 => 21,  40 => 17,  37 => 16,  35 => 11,  32 => 10,  30 => 7,  23 => 2,);
    }
}
