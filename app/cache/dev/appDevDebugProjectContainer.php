...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'plastprod', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\ROGER\\PlastProdBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ROGER\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'ROGER\\PlastProdBundle\\Entity');
        $c->addDriver($b, 'ROGER\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ROGERPlastProdBundle' => 'ROGER\\PlastProdBundle\\Entity', 'ROGERUserBundle' => 'ROGER\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_818e739fd4980a6ea574be01a2769c6db9b42fcea3e9cf9907514186c6b03ff7');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ROGER\\UserBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ROGER\\UserBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ROGER\\UserBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ROGER\\UserBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ROGER\\UserBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('ROGER\\UserBundle\\Entity\\Utilisateurs' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/PlastProd/Client/Suivi');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/PlastProd/Production*');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/PlastProd/Fournisseurs/*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/PlastProd/Stocks*');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/PlastProd/Config*');
        ...
        $n->add($j, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        $n->add($k, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        $n->add($l, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        ...
        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, '/PlastProd'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $s->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => '/PlastProd', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $u = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $p, 'main', $s, $t, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $u->setRememberMeServices($q);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $o, 1 => $c), 'main', $a, $d), 2 => $r, 3 => $u, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $q, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54f87bb59bf15', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $p, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $p, 'fos_user_security_login', false), '/PlastProd/Client/Suivi', NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ROGER\\PlastProdBundle/Resources/views'), 'ROGERPlastProd');
        $instance->addPath(($this->targetDirs[3].'\\src\\ROGER\\UserBundle/Resources/views'), 'ROGERUser');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_PROD', 2 => 'ROLE_FOURNISSEURS', 3 => 'ROLE_STOCKS'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ROGERPlastProdBundle' => 'ROGER\\PlastProdBundle\\ROGERPlastProdBundle',
                'ROGERUserBundle' => 'ROGER\\UserBundle\\ROGERUserBundle',
            ...
            'fos_user.model.user.class' => 'ROGER\\UserBundle\\Entity\\Utilisateurs',
