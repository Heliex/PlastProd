...
class Nomenclature
{
    ...
    /**
     * Set affectation_matiere
     *
     * @param integer $affectationMatiere
     * @return Nomenclature
     */
    public function setAffectationMatiere($affectationMatiere)
    {
        $this->affectation_matiere = $affectationMatiere;

        return $this;
    }

    /**
     * Get affectation_matiere
     *
     * @return integer 
     */
    public function getAffectationMatiere()
    {
        return $this->affectation_matiere;
    }
}
